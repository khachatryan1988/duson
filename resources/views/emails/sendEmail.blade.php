...
<body>
{{--  {{ $status }}--}}
<div class="container mx-auto">@if($status == 'pending')
        <p class="mt-2 mb-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-3xl">{{ __('order_pending') }}</p>
    @elseif($status == 'success')
        <p class="mt-2 mb-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-3xl">{{ __('order_success') }}</p>
...
{{--        </style>--}}
    @elseif($status == 'error')
        <p class="mt-2 mb-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-3xl">{{ __('order_error') }}</p>
@endif
</div>
